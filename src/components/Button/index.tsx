...
function ButtonRoot({ size = 'sm', children, asChild, className, color = 'bg-yellow', ...props }: ButtonProps) {
    const Comp = asChild ? Slot : 'button'
    return (
        <Comp className={clsx("flex items-center justify-center gap-3  border-2 rounded-[50px] font-semibold  ",
