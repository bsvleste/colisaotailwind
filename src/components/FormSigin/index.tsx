                    ...
                    <form action="" className="mt-4" onSubmit={handleLogin} >
                        <div className="">
                            ...
                            <TextInput.Root>
                                ...
                                <TextInput.Input type="email" placeholder="Digite seu e-mail" onChange={(e) => setEmail(e.target.value)} />
                            </TextInput.Root>
                        ...
                        <div className="mt-6">
                            ...
                            <TextInput.Root>
                                ...
                                <TextInput.Input type="password" placeholder="*************" onChange={(e) => setPassword(e.target.value)} />
                            </TextInput.Root>
