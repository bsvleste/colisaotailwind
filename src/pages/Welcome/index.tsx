    ...
    return(
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mt-16 sm:mt-0 mx-auto">
            ...
            <div className="flex flex-col justify-center sm:bg-colisao-500 sm:text-black sm:items-center  sm:h-screen">
               ...
               <button className="rounded-md text-black bg-colisao-500 sm:bg-black sm:text-colisao-500 w-full sm:w-[90%] sm:mx-auto h-14" onClick={()=>{navigate("/sign-in")}}>Sign In Now</button>
            </div>
